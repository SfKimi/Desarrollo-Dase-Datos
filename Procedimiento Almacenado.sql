...
/*PUNTO 1*/
/* Cree una función que reciba dos valores numéricos correspondientes a
...
BEGIN
 ...
 END;
/*PUNTO 2*/
/*Realice un "select" mostrando el código del producto, ambos stocks y,
empleando la función creada anteriormente, una columna que muestre el
estado del producto*/
